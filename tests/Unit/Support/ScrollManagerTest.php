...
class ScrollManagerTest extends TestCase
{
    ...
    public function test_scaffold_generated_files_are_not_judged(): void
    {
        // Isolate the scroll to a dedicated temp subdirectory — judgeFile now
        // builds the full-scroll index, so pointing the scroll at the whole
        // system temp dir would parse every PHP file under it.
        $dir = sys_get_temp_dir() . '/cc_scaffold_' . uniqid();
        mkdir($dir);
        ...
        // Build the marker from parts so this test's own source file does not
        // contain it (or judging __FILE__ in sibling tests would be skipped).
        $marker = '@code-commandments' . '-generated';
        $file = $dir . '/GeneratedThing.php';
        file_put_contents($file, "<?php\n\n/**\n * Generated by code-commandments.\n *\n * {$marker}\n */\nfinal class GeneratedThing {}\n");
