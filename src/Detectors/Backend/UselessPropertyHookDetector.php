 ...
 * declarations, get/set pairs, a body reading `static::` (the late-bound class IS the object,
 * so each subclass gets its own value), and Data-class territory (a Spatie `Data` class or a
 * trait a Data class consumes — computed/page-object fields are their idiom) are left alone.
