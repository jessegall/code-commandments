...
final class Templates extends Skill
{
    ...
    {
        return "Templates — state the shape, don't assemble it";
    }

    public function trigger(): string
    {
        return "Writing a multi-line string a program emits — generated code, a config block, a report, a message. Read this the moment you find yourself building one line at a time and joining, so the OUTPUT stays readable in the source that produces it.";
    }

    public function intro(): string
    {
        return "A template is a picture of its output. Write it as one — a heredoc, at its real
...
fragments and they have to run it in their head.";
    ...
    {
        return "a multi-line string is a heredoc that SHOWS its output, never a list of line fragments joined.";
    }
...
PRINCIPLE;
    ...
    {
        return [
            Documentation::class => "the same instinct one scale down: say a thing once, in the form a reader can check.",
            ValueObjects::class => "a shape worth stating repeatedly is usually a type, not a string.",
        ];
    }
}
