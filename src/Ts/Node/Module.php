...
/**
 * A parsed TypeScript module — its imports and its top-level statements. It answers the structural
 * questions ON the tree rather than leaving callers to re-scan for them: find a declaration by name,
 * the fields of a local type, the macro and composable calls, and every bound local name.
 */
