...
final class HookEvent
{
     ...
     * subagent; the main session carries neither. Our hooks — the judge/cardinal-rule reminders, the
     * skill-invocation nudges — are meaningful ONLY to the session that owns the work; in a read-only subagent they are noise that can derail its task, so every moment is
