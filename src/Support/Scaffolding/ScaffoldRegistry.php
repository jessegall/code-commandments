    ...
    public static function all(): array
    {
        return [
            ...
            new Scaffold(
                ...
                introducedIn: '2.71.0',
                purpose: 'Root of the classifier family — make() entry; replaces hardcoded type-name lists.',
                subNamespace: 'Classifiers',
            ),
            new Scaffold(
                name: 'classifier-composition',
                className: 'ComposesClassifiers',
                stubFile: 'ComposesClassifiers.stub',
                introducedIn: '2.71.0',
                purpose: 'Trait: boolean composition (allOf/anyOf/and/or), kind-scoped so classifiers cannot be mixed.',
                subNamespace: 'Classifiers',
            ),
            new Scaffold(
            ...
            new Scaffold(
                ...
                introducedIn: '2.71.0',
                purpose: 'Classify a VALUE (object / loadable FQCN) via is_a (+ vendor fallback).',
                subNamespace: 'Classifiers',
            ),
            new Scaffold(
                name: 'classifier-type',
                className: 'TypeClassifier',
                stubFile: 'TypeClassifier.stub',
                introducedIn: '2.71.0',
                purpose: 'Classify a TYPE by FQCN via is_a (walks interfaces + parents).',
                subNamespace: 'Classifiers',
            ),
        ];
    }
