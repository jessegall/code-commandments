...
final class Frozen
{
    ...
    /**
     * Is the file at $path frozen — declared so by a marker, or generated by the toolchain of its
     * language, which regenerates it over any hand edit?
     */
    public static function isFrozenFile(string $path, string $source): bool
    {
        $language = Language::ofFile($path);

        return self::isFrozen($source, $language) || $language->isGenerated($path, $source);
    }
