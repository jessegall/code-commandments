...
$disabledSkills = function (Config $config): void {
    $config->disable(
        ...
        // Skills\Python\DependencyDirection::class,
        ...
        // Skills\Python\PassTheObject::class,
        // Skills\Python\RepeatedCallHelper::class,
        // Skills\Python\RoleVocabulary::class,
        ...
        // Skills\CSharp\BehaviourPerMethod::class,
        // Skills\CSharp\ClassLayout::class,
        // Skills\CSharp\DependencyDirection::class,
        // Skills\CSharp\Documentation::class,
        ...
        // Skills\CSharp\PassTheObject::class,
        // Skills\CSharp\RepeatedCallHelper::class,
        // Skills\CSharp\TellDontAsk::class,
        // Skills\CSharp\Templates::class,
...
$disabledSins = function (Config $config): void {
    $config->disable(
        ...
        // Sins\Python\KeyedLookupEnvy::class,
        // Sins\Python\LoopWrappedInIf::class,
        // Sins\Python\MaskedInvariant::class,
        ...
        // Sins\Python\NamespaceDependency::class,
        ...
        // Sins\Python\NullableRegistryLookup::class,
        // Sins\Python\ParamResolvedFromParam::class,
        // Sins\Python\PhantomNullable::class,
        ...
        // Sins\Python\RestatedComment::class,
        ...
        // Sins\CSharp\NamespaceCycle::class,
        // Sins\CSharp\NamespaceDependency::class,
